...
class Welcome extends React.Component {
  render() {
    return (<div>
      <div className="jumbotron" style={{"paddingBottom": "100px"}}>
        ...
        <p className="lead">
          ...
          ?<Link style={{'cursor': 'pointer'}} className="btn btn-dark btn-lg early-access go-dashboard" to="account"><span>Account</span></Link>
